    ...
    methods
        ...
        function [H,VTA]=learn(obj,rw,s,s1,resp,RW,b,H)%outcome analysis and learning           
            ...
            if obj.omega==0 %if it's ACC Action
               H=0;%tanh((obj.varD(s,resp)))*abs(sign(RW));%compute estimated entropy
...
%                R=(rw*RW)-obj.HTlesion*obj.omega*b-H;%primary reward boost cost
%                VTA=obj.DAlesion*(R+obj.DAlesion*max(obj.V(s1,:)));
